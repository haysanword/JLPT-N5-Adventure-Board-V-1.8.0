...
export const lesson: Lesson = {
    id: 'n4-gr-4',
    level: 'N4',
    title: 'Tata Bahasa N4: Bentuk Pasif',
    description: 'Pelajari bentuk pasif (～られる) untuk menyatakan "dikenai tindakan" dan pasif penderitaan.',
    xp: 260,
    content: `
      <h1>Kalimat Pasif (うけみ) - Saat Subjek Dikenai Tindakan</h1>
    ...
    audioScript: 'Kalimat pasif menyatakan subjek dikenai tindakan. Ada pasif langsung, seperti "homeraremasu" (dipuji), dan ada juga pasif penderitaan, seperti "ame ni furaremashita," yang menunjukkan bahwa kita terganggu oleh hujan.',
     listeningSituation: {
      title: 'Situasi: Dipuji Guru',
      japaneseText: `A: 田中さん、今日の発表、とてもよかったですよ。
B: ほんとうですか。
A: はい、先生に褒められました。準備してよかったです。`,
      indonesianText: `A: Tanaka-san, presentasi hari ini bagus sekali lho.
B: Benarkah?
A: Ya, saya dipuji oleh guru. Saya senang sudah mempersiapkannya.`,
      audioScript: 'A: 田中さん、今日の発表、とてもよかったですよ。 B: ほんとうですか。 A: はい、先生に褒められました。準備してよかったです。'
    },
    quiz: [
    ...
    vocabulary: [
        ...
        { japanese: 'しかられます', romaji: 'shikararemasu', indonesian: 'Dimarahi' },
        { japanese: 'たてられます', romaji: 'tateraremasu', indonesian: 'Dibangun' }
    ],
    minimalPairs: [
      { options: ['よまれる', 'よばれる'], romaji: ['yomareru (dibaca)', 'yobareru (dipanggil)'], correctAnswer: 'よまれる' },
      { options: ['かかれる', 'かくれる'], romaji: ['kakareru (ditulis)', 'kakureru (bersembunyi)'], correctAnswer: 'かかれる' },
      { options: ['ふられる', 'ふれる'], romaji: ['furareru (dihujani/ditolak cinta)', 'fureru (menyentuh)'], correctAnswer: 'ふられる' }
    ]
  };